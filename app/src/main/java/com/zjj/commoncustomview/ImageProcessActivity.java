...
public class ImageProcessActivity extends AppCompatActivity {
    private final static String TAG = ImageProcessActivity.class.getSimpleName();
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean result) {
                if (result) {
                    ...
                    dismissProgress();
                    Toast.makeText(ImageProcessActivity.this, "load trainedData failed", Toast.LENGTH_SHORT).show();
                }
            }
